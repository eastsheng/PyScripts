...
if __name__ == '__main__':
	# perform the code by commanding in cmd or bash 
	# python LAMMPSdata_form_ms.data
	# 只适用于sio2 
	print("You need to Modify your head info of data by hand...")
	# inital lammpsdata obtained from msi2lmp.exe tool
	msi_data = "quartz_alpha.data"
	# msi_data = sys.argv[1]
	clayff_data = msi_data.split(".")[0]+"_clayff.data"
